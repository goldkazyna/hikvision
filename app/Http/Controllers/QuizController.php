...
- Буквы: "А","Б","В","A","B","C","бэ","вэ","а","б","в"
- Номера: "первый","второй","третий","один","два","три","1","2","3"
- Фразы: "вариант А","вариант Б","вариант В"
- Фонетическое сходство: английские термины могут быть произнесены на русский лад (например "ВИДИЭР"="WDR", "колор вью"="ColorVu", "эйч 265"="H.265+")
- Частичные совпадения: даже одно ключевое слово из варианта — достаточно
- ВАЖНО: Whisper часто искажает короткие ответы! "Б" может стать "бэм","всем пока","бум","п","be". "В" может стать "вэ","ви","we". Ищи ближайшую букву!
